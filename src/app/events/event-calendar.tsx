...
export function EventCalendar({ currentUser, initialEvents, initialParticipants, people, preview = false }: { currentUser: Profile; initialEvents: Event[]; initialParticipants: Participant[]; people: Profile[]; preview?: boolean }) {
