...
export default function Loading() {
  return (
    <main className="min-h-dvh bg-muted/20" role="status" aria-live="polite" aria-label="イベント企画画面を読み込み中">
      <header className="flex flex-wrap items-center justify-between gap-3 border-b bg-card px-4 py-3 md:px-8"><div><Skeleton className="mb-2 h-6 w-72" /><Skeleton className="h-3 w-96 max-w-full" /></div><Skeleton className="h-4 w-56" /></header>
